...
//<!-- i am making the constructor so that i can easily call the modle in short load database every time i use this class -->
  ...
  public function welcome(){
    $this->load->view('p_forms/welcome_user');
  }
  public function unauthorized(){
    $this->load->view('p_forms/unauthorized_page');
  }
  public function login_user(){
    ...
    if($this->form_validation->run() === TRUE){
      ...
      if($userObject !== NULL){
        $this->session->set_userdata('username', $userObject->u_name);
        $this->session->set_userdata('email', $userObject->email);
        $this->session->set_userdata('logged_in', TRUE);
        redirect('RegistrationController/welcome');
      ...
      redirect('RegistrationController/unauthorized');
  //  redirect('RegistrationController/welcome');
}else{
      $this->load->view('p_forms/login_form');
  ...
  //  print_r($object);
    ...
    $this->session->set_userdata('username',$object->u_name);
